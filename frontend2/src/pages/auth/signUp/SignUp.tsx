      ...
      <Card className={`${classes.card} auth-premium-card border-0 py-0`}>
        <CardHeader className={classes.cardHeader}>
          ...
          <p className={classes.subtitle}>
            El acceso al gimnasio lo crea un administrador cuando te incorpor?s.
          </p>
        </CardHeader>
        ...
        <CardContent className={classes.cardContent}>
          <div className={classes.form}>
            <p className={classes.subtitle}>
              Pedile al administrador que cree tu usuario con tu email y te
              asigne un PIN. Despu?s ingres?s desde la pantalla de login.
            </p>
